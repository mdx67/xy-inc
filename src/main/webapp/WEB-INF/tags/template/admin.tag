        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
	            	              <li><a href="<c:url value='/position/form'/>"><span class="glyphicon glyphicon-plus-sign"></span> Add position</a></li>	              
	              <li><a href="<c:url value='/position'/>"><span class="glyphicon glyphicon-menu-hamburger"></span> List position</a></li>
